...
public class StringToPropertyValueMapEntryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringToPropertyValueMapEntry_key_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_StringToPropertyValueMapEntry_key_feature", "_UI_StringToPropertyValueMapEntry_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 NotationPackage.Literals.STRING_TO_PROPERTY_VALUE_MAP_ENTRY__KEY,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns StringToPropertyValueMapEntry.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StringToPropertyValueMapEntry")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return "" + stringToPropertyValueMapEntry.getKey() + " -> " + stringToPropertyValueMapEntry.getValue(); //$NON-NLS-1$ //$NON-NLS-2$
	}
