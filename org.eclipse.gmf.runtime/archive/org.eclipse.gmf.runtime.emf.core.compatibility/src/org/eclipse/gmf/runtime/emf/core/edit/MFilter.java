 ...
 * @author rafikj
 * 
 * @deprecated Use a {@link org.eclipse.emf.transaction.NotificationFilter} on
 *    your {@link org.eclipse.emf.transaction.ResourceSetListener}s, instead.
 *    This class provides most of the same standard filter types.  Where it
 *    does not support your particular filtering requirements, implement the
 *    filter internally in the listener call-back method(s). 
 */
