 ...
 * 
 * @deprecated The only checked exception in the
 *    {@link org.eclipse.emf.transaction.TXEditingDomain} and related APIs is
 *    the {@link org.eclipse.emf.transaction.RollbackException} (plus others
 *    such as {@link InterruptedException} defined by the JDK).
 */
