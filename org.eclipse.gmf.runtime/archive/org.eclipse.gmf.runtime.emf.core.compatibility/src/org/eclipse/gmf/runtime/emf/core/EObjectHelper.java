 ...
 * 
 * @deprecated This class is mostly obsoleted by the {@link org.eclipse.gmf.runtime.emf.core.util.EMFCoreUtil} API.
...
public class EObjectHelper
	...
	private static final IStatus OK_STATUS = new Status(IStatus.OK, MSLPlugin
		.getPluginId(), 0, MSLCoreMessages.validation_none,
		null);
	...
	private static IStatus combineValidationResults(Collection statuses) {
		...
		if (result.isEmpty()) {
			...
			return new MultiStatus(MSLPlugin.getPluginId(), 0,
				...
				MSLCoreMessages.validation_multi, null);
		}
	}
