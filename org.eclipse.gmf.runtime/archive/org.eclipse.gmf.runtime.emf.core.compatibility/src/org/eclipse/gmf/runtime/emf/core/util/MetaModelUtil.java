 ...
 * @author rafikj
 * 
 * @deprecated Use the {@link PackageUtil} class, instead.  See  individual
 *    method documentation for replacements.  Note that for containment
 *    relationships, the {@link PackageUtil} class does not consult the
 *    deprecated {@link IMetamodelSupport} extension point for overrides of the
 *    containment relationships declared by the metamodel.
 */
public class MetaModelUtil {
	 ...
	 * @return The ID.
	 * 
	 * @deprecated Use the {@link PackageUtil#getID(ENamedElement)} method.
	 */
	 ...
	 * 
	 * @deprecated Use the {@link PackageUtil#getElement(String)} method.
	 */
	 ...
	 * 
	 * @deprecated Use the {@link PackageUtil#getLocalizedName(ENamedElement)} method.
	 */
	 ...
	 * @return The localized name of the meta-model element.
	 * 
	 * @deprecated Use the {@link PackageUtil#getDisplayName(ENamedElement)} method.
	 */
	 ...
	 * 
	 * @deprecated Use the {@link PackageUtil#canContain(EClass, EClass, boolean)}
	 *     method.  Note that the new API does not consult the deprecated
	 *     {@link org.eclipse.gmf.runtime.emf.core.services.metamodel.IMetamodelSupport}
	 *     extension API for overrides of the containment relationships declared
	 *     by the metamodel.
	 */
	 ...
	 * @return True if an object can contain other objects of a given type.
	 * 
	 * @deprecated Use the {@link PackageUtil#canContain(EClass, EReference, EClass, boolean)}
	 *     method.  Note that the new API does not consult the deprecated
	 *     {@link org.eclipse.gmf.runtime.emf.core.services.metamodel.IMetamodelSupport}
	 *     extension API for overrides of the containment relationships declared
	 *     by the metamodel.
	 ...
	 * @return True if an object can contain other objects of a given type.
	 * 
	 * @deprecated Use the {@link PackageUtil#canReference(EClass, EClass)}
	 *     method.  Note that the new API does not consult the deprecated
	 *     {@link org.eclipse.gmf.runtime.emf.core.services.metamodel.IMetamodelSupport}
	 *     extension API for overrides of the reference relationships declared
	 *     by the metamodel.
	 */
	 ...
	 * @return True if an object can contain other objects of a given type.
	 * 
	 * @deprecated Use the {@link PackageUtil#canReference(EClass, EReference, EClass)}
	 *     method.  Note that the new API does not consult the deprecated
	 *     {@link org.eclipse.gmf.runtime.emf.core.services.metamodel.IMetamodelSupport}
	 *     extension API for overrides of the reference relationships declared
	 *     by the metamodel.
	 ...
	 * 
	 * @deprecated Use the {@link PackageUtil#findFeature(EClass, EClass)}
	 *     method.
	 */
	 ...
	 * 
	 * @deprecated Use the {@link PackageUtil#getNameAttribute(EClass)}
	 *     method.
	 */
	 ...
	 * 
	 * @deprecated Use the {@link PackageUtil#getQualifiedNameAttribute(EClass)}
	 *     method.
	 */
