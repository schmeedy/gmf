 ...
 * @author rafikj
 * 
 * @deprecated The unit of work in a {@link org.eclipse.emf.transaction.TXEditingDomain}
 *     domain is the {@link org.eclipse.emf.transaction.Transaction}.  All
 *     transaction-based
 *     {@link org.eclipse.emf.transaction.RecordingCommand commands} and
 *     {@link org.eclipse.emf.workbench.AbstractEMFOperation operations} are
 *     self-undoable.  Where necessary, a transaction can provide its changes
 *     in an undoable format via its
 *     {@link org.eclipse.emf.transaction.Transaction#getChangeDescription() change description}. 
 */
