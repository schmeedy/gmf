 ...
 * @author rafikj
 * 
 * @deprecated Use the {@link org.eclipse.gmf.runtime.emf.core.resources.IResourceHelper}
 *      API, instead.
 */
public interface MResource {
	...
	public class Helper extends ResourceHelperImpl {
		// compatibility with new IResourceHelper API
